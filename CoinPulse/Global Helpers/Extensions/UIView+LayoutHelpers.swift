...
extension UIView {
    ...
    public func fillSuperviewSafeLayout(){
    ...
    guard let superview = self.superview else { return }
        ...
        leftAnchor.constraint(equalTo: layoutGuide.leftAnchor).isActive = true
        rightAnchor.constraint(equalTo: layoutGuide.rightAnchor).isActive = true
